...
@fmodels.register_model("graphormer_HILIC")
class GraphormerModel(fmodels.FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--activation-fn",
            choices=futils.get_available_activation_fns(),
    ...
    def build_model(cls, args, task):
        ...
        if not futils.safe_hasattr(args, "max_nodes"):
...
@fmodels.register_model_architecture("graphormer_HILIC", "graphormer_HILIC")
